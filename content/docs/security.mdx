...
If you believe you have found a security vulnerability in BotSignal.Dev, please do not disclose it publicly. Email us immediately at hello@BotSignal.Dev so we can investigate and patch the issue promptly.