...
Security and data privacy are foundational to RoastMySite.AI. Because we process website data and interface with external AI models, we have implemented strict protocols to ensure your account and data remain safe.
...
## Payment Security
All billing and credit purchases are processed directly through **a third party provider**. RoastMySite.AI does not collect, process, or store your credit card numbers or banking information on our servers.

## Vulnerability Reporting
If you believe you have found a security vulnerability in RoastMySite.AI, please do not disclose it publicly. Email us immediately at support@roastmysite.ai so we can investigate and patch the issue promptly.