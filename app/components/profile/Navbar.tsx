...
import {Bell, PaintBucket, Sparkles, User, ChevronDown, ArrowRight, Zap} from "lucide-react";
...
export default function ProfileNavbar() {
	...
	useEffect(() => {
		...
		// Check if the user has an active token (based on your user.service.js logic)
	...
	return (
		<header className="fixed top-0 left-0 md:left-64 right-0 z-40 h-16 flex items-center justify-between border-b border-gray-200/60 bg-white/70 backdrop-blur-xl shadow-sm px-4 md:px-8 transition-all duration-300">
			...
			<div className="flex items-center gap-3 md:gap-5">
				...
				{!isMounted ? (
					// Skeleton loader while checking auth state to prevent UI jumping
