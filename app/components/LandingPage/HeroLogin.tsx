		...
		<section className="relative pt-48 pb-section-gap px-container-padding min-h-[90vh] flex flex-col items-center justify-center text-center overflow-hidden">
			...
			<div className="w-full max-w-[700px] bg-white/40 rounded-3xl border border-white/60 shadow-[0_8px_32px_rgba(0,0,0,0.04)] p-6 mb-8 backdrop-blur-xl transition-all focus-within:shadow-[0_8px_32px_rgba(0,0,0,0.08)] focus-within:border-white/80">
				<form className="flex flex-col gap-4">
					...
					{/* Google Login Button */}
					<a target="_blank" rel="noopener noreferrer" href="https://api.botsignal.dev/accounts/google/login" className="w-full bg-white cursor-pointer border border-gray-200 text-gray-700 hover:bg-gray-50 font-body-md font-medium rounded-xl px-8 py-3 flex items-center justify-center gap-3 shadow-[0_4px_14px_rgba(0,0,0,0.05)] hover:shadow-[0_6px_20px_rgba(0,0,0,0.08)] transition-all active:scale-95 group">
